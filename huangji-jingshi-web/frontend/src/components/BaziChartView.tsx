          ...
          return (
            ...
            >
              ...
              <div className="text-[10px] text-gray-500 uppercase tracking-widest mb-3 text-center">
                {pillar.label}
                {pillar.isMain && <span className="ml-1 text-gold">★</span>}
              </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-1.5">
              ...
              <span
                className={`text-sm font-bold ${WUXING_COLORS[extractWuxing(data.wuxing_analysis.day_master)]?.text || 'text-white'}`}
              >
            ...
            >
              ...
              <div className="space-y-6 text-sm text-gray-300">
                ...
                <section>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="p-3 rounded-xl bg-white/5">
                      ...
                      <span
                        className={`ml-2 ${WUXING_COLORS[extractWuxing(data.wuxing_analysis.day_master)]?.text}`}
                      >
                  ...
                  <section>
                    ...
                    <div className="grid grid-cols-4 gap-2">
                      {[
                        {
                          label: '年柱',
                          god: data.ten_gods_summary.year_gan,
                          pillar: data.year_pillar,
                        },
                        {
                          label: '月柱',
                          god: data.ten_gods_summary.month_gan,
                          pillar: data.month_pillar,
                        },
                        {
                          label: '日柱',
                          god: data.ten_gods_summary.day_gan,
                          pillar: data.day_pillar,
                        },
                        {
                          label: '时柱',
                          god: data.ten_gods_summary.hour_gan,
                          pillar: data.hour_pillar,
                        },
                      ].map((item) => (
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-3">
                                ...
                                <div className="text-xs text-gray-400">第{cycle.cycle}运</div>
                              </div>
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center justify-between mb-1">
                              ...
                              {isCurrent && (
                                <span className="text-[9px] px-1.5 py-0.5 rounded bg-gold text-black">
                                  当前
                                </span>
                              )}
                            </div>
                  ...
                  <section>
                    ...
                    <div className="p-3 rounded-xl bg-white/5">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-xs text-gray-500">{data.xiaoyun.gan_wuxing}</div>
                      </div>
                    </div>
                  </section>
                )}
                ...
                <div className="p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-200/80 text-xs">
                  <strong className="text-emerald-300">✓ 已完善：</strong>{' '}
                  本系统已集成十神、大运、流年、小运等传统八字分析要素，提供全面的命理解读。
                </div>
              </div>
            </div>
          </div>,
